...
class AccountController extends Controller
{
    ...
    public function processRegistration(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $user->role = ($request->input('role') == 'employee' ? 'user' : 'employer');
            $user->save();
    ...
    public function updateProfilePic(Request $request)
    {
        ...
        // Get the authenticated user or fetch the user by ID
    ...
    public function createJob()
    {
        ...
        // admin can not apply on job
        if (Auth::user()->role == 'admin') {
            $message = 'You can not create any job.';
    ...
    public function myJobApplications()
    {
        if (Auth::user()->role == 'user') {
            ...
            $jobApplications = JobApplication::where('employer_id', Auth::user()->id)
                ->with(['job', 'job.jobType', 'job.applications'])
                ->orderBy('created_at', 'DESC')
                ->paginate(10);
        }

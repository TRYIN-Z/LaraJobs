                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    @if ($jobs->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            <td>
                                                <div class="job-name fw-bold">{{ $job->title }}</div>
                                                <div class="info1">{{ $job->jobType->name }} . {{ $job->location }}</div>
                                            </td>
                                            <td>{{ \Carbon\Carbon::parse($job->created_at)->format('d M, Y') }}</td>
                                            <td>{{ $job->applications->where('status', 'accepted')->count() }} Applications</td>
                                            <td>
                                                @if ($job->status == 1)
                                                <div class="job-status text-capitalize text-green-500">Active</div>
                                                @else
                                                <div class="job-status text-capitalize text-red-500">Block</div>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="action-dots">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item hover:text-red-600" href="#" onclick="deleteJob({{ $job->id }})" ><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="5"
                                                ...
                                                <span class="font-semibold">No Job Created</span>
                                            </td>
                                        </tr>
                                    @endif

...
<section class="section-5 bg-2">
    <div class="container py-5">
        <div class="row">
            <div class="col">
                <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4 shadow-lg">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item text"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item text-blue-400 hover:text-purple-400"><a href="{{ route("admin.users") }}">Users</a></li>
                    ...
                    <div class="card-body card-form">
                        <form action="{{ route('admin.users.update', $user->id) }}" method="post" id="userForm" name="userForm">
                            ...
                            <div class="card-footer p-4">
                                <button type="submit" class="btn btn-gradient fw-bold rounded-full">Update</button>
                            </div>
                        </form>
                    </div>
                </div>

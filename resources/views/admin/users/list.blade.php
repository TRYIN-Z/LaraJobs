                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-white rounded-3 shadow-lg p-3">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active text-slate-600" aria-current="page">User</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-0 shadow-lg mb-4">
                        <div class="card-body card-form">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div>
                                    <p class="text-slate-800 fw-bold fs-4 mb-0">
                                                        ...
                                                        <div class="action-dots ">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                {{-- <li><a class="dropdown-item"
                                                                        ...
                                                                        Edit</a></li> --}}
                                                                <li><a class="dropdown-item hover:text-red-600" href="javascript:void(0);"

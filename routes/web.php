...
Route::patch('/applications/{applicationId}/accept', [EmployerController::class, 'acceptApplication'])->name('acceptApplication');
Route::patch('/applications/{applicationId}/reject', [EmployerController::class, 'rejectApplication'])->name('rejectApplication');
